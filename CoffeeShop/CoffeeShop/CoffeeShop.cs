...
{ public partial class CoffeeShop : Form
    { public CoffeeShop()
        ...
        public int FixtReat()
        {int reat = itemComboBox.SelectedIndex == 1 ? 120:itemComboBox.SelectedIndex==2?100:itemComboBox.SelectedIndex==3?90:itemComboBox.SelectedIndex==4?80:0;
            return reat;}
 public string Show()
 {string output = "";
            int Index = 0;
 foreach (var Name in Names)
  { output = output + "Customer Name= " + Name + "\nPhone No.= " + Numbers[Index] + "\nAddress= " + Address[Index] + "\nItem= " + Items[Index] + "\nReat= " + Reats[Index] + "\nQuantity= " +
     quantitys[Index] + "\nTotal Price:" + Reats[Index] + "*" + quantitys[Index] + " =" +(Convert.ToDecimal(Reats[Index])*(Convert.ToDecimal(quantitys[Index]))) + "\n\n";
                Index++;
            }
            return output;
        }
